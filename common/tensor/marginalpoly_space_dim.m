function[N] = marginalpoly_space_dim(dim, p)
% marginalpoly_space_dim -- dimension of subspace spanned by polynomials
%
% N = marginalpoly_space_dim(dim, p)
%
%     Returns the dimension of the polynomial space of dim-variate polynomials
%     of marginal degree less than or equal to p. Is vectorized in p.
