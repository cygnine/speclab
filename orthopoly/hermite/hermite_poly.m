function[p] = hermite_poly(x,n,varargin)
% hermite_poly -- evaluate Hermite polynomials
%
% [p] = hermite_poly(x,n,{mu=0,d=0,shift=0,scale=1,dim=1})
%
...
if isempty(recurrence)
  from speclab.orthopoly.hermite import recurrence
