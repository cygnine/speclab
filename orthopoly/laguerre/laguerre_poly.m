function[p] = laguerre_poly(x,n,varargin)
% laguerre_poly -- evaluate Laguerre polynomials
%
% [p] = laguerre_poly(x,n,{alpha=0,d=0,shift=0,scale=1})
%
...
if isempty(recurrence)
  from speclab.orthopoly.laguerre import recurrence defaults
