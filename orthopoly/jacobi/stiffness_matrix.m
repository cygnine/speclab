...
if isempty(defaults)
  ...
  from speclab.orthopoly.jacobi import derivative_connection as derivative
  from speclab.orthopoly.jacobi import integer_separation_connection_matrix as connection
end
