classdef Chebyshev3PolynomialBasis < JacobiPolynomialBasis
  methods
    function self = Chebyshev3PolynomialBasis(varargin)
    % self = Chebyshev3PolynomialBasis(varargin)
    %
    %     Creates an instance of a Chebyshev3 Polynomial spectral basis.
