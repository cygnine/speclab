...
% from_naturals -- mapping from naturals for TotalReverseLexicographicIndexing
% 
...
n_max = n(end);
total_degrees = -1*ones(size(n));

% Here's the plan of action:
% 1.) Compute + store all necessary total degrees
% 2.) For each total degree, compute all multi-indices, pluck out ones in n

% Compute and store total degrees:
current_index = 1;
