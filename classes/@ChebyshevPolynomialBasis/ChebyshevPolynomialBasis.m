classdef ChebyshevPolynomialBasis < JacobiPolynomialBasis
  methods
    function self = ChebyshevPolynomialBasis(varargin)
    % self = ChebyshevPolynomialBasis(varargin)
    %
    %     Creates an instance of a Chebyshev Polynomial spectral basis.
