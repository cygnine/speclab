...
if isempty(defaults)
  ...
  from speclab.orthopoly1d.laguerre.coefficients import derivative
  from speclab.orthopoly1d.laguerre.connection import integer_separation_connection_matrix as connection
end
