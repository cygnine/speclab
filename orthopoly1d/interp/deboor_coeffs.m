function[c] = deboor_coeffs(l,W,p,k,u,D,f, varargin)
% deboor_coeffs -- Computes basis coefficients for interpolation
%
% c = deboor_coeffs(l,W,p,k,u,dim,f, [ip=alpha!])
%
...
%       p(x) = sum_n c(n) * m(x,n),
%
%     where m(x,n) is a function that evaluates the n'th basis function at the
...
if isempty(invu)
  ...
  from speclab.orthopoly1d.interp import monomial_ip as ip
end
