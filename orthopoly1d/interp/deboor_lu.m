function[l,W,p,k_storage,u] = deboor_lu(theta, varargin)
% deboor_lu -- Computes de Boor's LW factorization
%
% [l,W,p,k,u] = deboor_lu(theta, [tol=1e-10, ip=alpha!,  basis=multimonomial])
%
